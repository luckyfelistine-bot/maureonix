...
// Auto Delete Helper — messages auto-delete after 5.5 minutes
...
// ════════════════════════════════════════════════════════════════
// MAIN HANDLER – exactly as original, but translated to English
// ════════════════════════════════════════════════════════════════
            ...
            try {
                ...
                if (set.autostatus) {
                    ...
                    try {
                        ...
                        _viewed = true;
                        console.log(`👁️ AutoStatus View - @${_statusSender.split('@')[0]}`);
                    } catch (e1) {
...
──────────────────`;
            ...
            if (isNaN(choice) || choice < 1 || choice > 21) {
                return await sendAutoDelete(nimesha, m.chat, '⚠️ Reply with a number between 1 and 21!', botFooter, { quoted: m });
            }
        ...
        // ── ATTP ANIMATED STICKER ─────────────────────────────
            ...
            try {
                ...
                if (imgBuffer) {
                    ...
                    await editAutoDelete(nimesha, m.chat, `❌ Could not generate ATTP sticker`, botFooter, atttpWaitMsg.key);
                }
            }
        }
        ...
        // ── ANIME GIFS ───────────────────────────────────────
            ...
            } else await sendAutoDelete(nimesha, m.chat, `❌ Could not get ${cmd} GIF`, botFooter, { quoted: m });
        }

...
.border-scan.top{top:0;amaureonixtion:borderScanH 3s linear infinite}
.border-scan.bottom{bottom:0;amaureonixtion:borderScanH 3s linear infinite reverse}
...
.border-scan.left{left:0;amaureonixtion:borderScanV 4s linear infinite}
.border-scan.right{right:0;amaureonixtion:borderScanV 4s linear infinite reverse}
...
.scan-fine{position:absolute;inset:0;background:repeating-linear-gradient(0deg,transparent,transparent 2px,rgba(0,240,255,0.035) 2px,rgba(0,240,255,0.035) 4px);amaureonixtion:scanFine 6s linear infinite}
...
.scan-bar{position:absolute;top:-12%;left:0;width:100%;height:12%;background:linear-gradient(180deg,transparent 0%,rgba(0,240,255,0.06) 40%,rgba(0,255,136,.08) 50%,rgba(0,240,255,0.06) 60%,transparent 100%);filter:blur(8px);amaureonixtion:scanBar 6s cubic-bezier(0.37,0,0.63,1) infinite;box-shadow:0 0 50px rgba(0,240,255,0.15)}
.scan-bar:nth-child(4){amaureonixtion-delay:2s;amaureonixtion-duration:7s;opacity:0.4}
.scan-bar:nth-child(5){amaureonixtion-delay:4s;amaureonixtion-duration:8s;opacity:0.25;background:linear-gradient(180deg,transparent,rgba(255,123,44,.06),transparent)}
.scan-vignette{position:absolute;inset:0;background:radial-gradient(circle at 50% 50%,transparent 25%,rgba(0,0,0,.55) 100%)}
.bg-mesh{position:fixed;inset:0;z-index:0;background:radial-gradient(ellipse 80% 50% at 20% 30%,rgba(0,102,255,0.12) 0%,transparent 60%),radial-gradient(ellipse 60% 40% at 80% 70%,rgba(0,240,255,0.15) 0%,transparent 50%),radial-gradient(ellipse 50% 50% at 50% 50%,rgba(255,123,44,.025) 0%,transparent 60%);amaureonixtion:meshMove 25s cubic-bezier(0.37,0,0.63,1) infinite alternate}
...
#flash.active{amaureonixtion:flashAnim 0.9s var(--ease-out-expo) forwards}
...
.infinity-amaureonixte .infinity-path{amaureonixtion:drawInfinity 2.2s var(--ease-out-expo) forwards}
...
.gate-crt{position:absolute;inset:0;background:repeating-linear-gradient(0deg,transparent,transparent 1px,rgba(0,240,255,0.035) 1px,rgba(0,240,255,0.035) 2px);pointer-events:none;z-index:2;amaureonixtion:crtFlicker 0.12s infinite}
.gate-chromatic{position:absolute;inset:0;pointer-events:none;z-index:3;mix-blend-mode:screen;opacity:0.07;background:linear-gradient(90deg,rgba(255,0,0,.12) 0%,transparent 33%,transparent 66%,rgba(0,255,255,.12) 100%);amaureonixtion:chromaticShift 4s ease-in-out infinite}
.gate-grid{position:absolute;inset:0;background-image:linear-gradient(rgba(0,240,255,0.035) 1px,transparent 1px),linear-gradient(90deg,rgba(0,240,255,0.035) 1px,transparent 1px);background-size:35px 35px;perspective:600px;transform-style:preserve-3d;amaureonixtion:gateGridMove 20s linear infinite}
...
.gate-ring{position:absolute;border:1px solid var(--border-bright);border-radius:50%;top:50%;left:50%;transform:translate(-50%,-50%);amaureonixtion:gateRingPulse 4s ease-in-out infinite}
.gate-ring:nth-child(1){width:30%;height:30%;amaureonixtion-delay:0s;border-color:rgba(255,123,44,.4);border-width:2px}
.gate-ring:nth-child(2){width:50%;height:50%;amaureonixtion-delay:0.4s}
.gate-ring:nth-child(3){width:70%;height:70%;amaureonixtion-delay:0.8s;border-color:rgba(0,255,136,.25)}
.gate-ring:nth-child(4){width:90%;height:90%;amaureonixtion-delay:1.2s;border-color:rgba(0,102,255,.2)}
.gate-ring:nth-child(5){width:110%;height:110%;amaureonixtion-delay:1.6s;border-color:var(--border-bright);border-style:dashed}
.gate-hex{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:min(70vw,70vh);height:min(70vw,70vh);max-width:500px;max-height:500px;pointer-events:none;opacity:0.15;amaureonixtion:hexRotate 60s linear infinite}
.gate-particles{position:absolute;inset:0;background-image:radial-gradient(circle,var(--cyan) 1px,transparent 1px);background-size:25px 25px;amaureonixtion:gateParticles 25s linear infinite;opacity:0.2}
...
.gate-content::before{content:'';position:absolute;inset:-2px;border-radius:calc(1.5rem + 2px);background:conic-gradient(from 0deg,var(--cyan),var(--green),var(--fox),var(--blue),var(--cyan));amaureonixtion:conicRotate 4s linear infinite;z-index:-1;opacity:0;transition:opacity 0.5s}
...
.gate-logo{width:100px;height:100px;border-radius:50%;object-fit:cover;border:2px solid rgba(255,123,44,.4);box-shadow:0 0 50px rgba(255,123,44,.5),0 0 100px rgba(255,123,44,.2);amaureonixtion:gateLogoFloat 4s ease-in-out infinite,gateLogoPulse 3.5s ease-in-out infinite;transition:all 0.5s ease;display:block;position:relative;z-index:2;margin:5px auto 0}
.gate-logo-shimmer{position:absolute;inset:0;border-radius:50%;background:linear-gradient(135deg,transparent 40%,rgba(255,255,255,.25) 50%,transparent 60%);background-size:200% 200%;amaureonixtion:shimmerMove 3s ease-in-out infinite;pointer-events:none;z-index:3;mix-blend-mode:overlay}
...
.gate-title::before{color:#ff0055;transform:translateX(-3px);clip-path:inset(0 0 50% 0);amaureonixtion:chromaticText 3s infinite}
.gate-title::after{color:#00ffff;transform:translateX(3px);clip-path:inset(50% 0 0 0);amaureonixtion:chromaticText 3s infinite reverse}
.gate-sub{font-family:var(--font-mono);font-size:clamp(0.6rem,2.5vw,0.8rem);color:var(--cyan);letter-spacing:0.3em;opacity:0.85;amaureonixtion:textFlicker 5s infinite;margin-bottom:1rem}
...
.gate-line{width:min(280px,60vw);height:2px;background:linear-gradient(90deg,transparent,var(--cyan),var(--green),var(--fox),transparent);margin:1.5rem auto 0;opacity:0.8;amaureonixtion:lineExpand 3.5s ease-in-out infinite;box-shadow:0 0 25px rgba(0,240,255,0.15);position:relative;overflow:hidden}
.gate-line::after{content:'';position:absolute;top:0;left:-100%;width:100%;height:100%;background:linear-gradient(90deg,transparent,rgba(255,255,255,.7),transparent);amaureonixtion:lineShine 2s infinite}
.sound-bars{display:flex;align-items:flex-end;justify-content:center;gap:3px;height:20px;margin-top:1.25rem;opacity:0.6}
.sbar{width:3px;background:var(--cyan);border-radius:2px;amaureonixtion:soundBar 1s ease-in-out infinite}
.sbar:nth-child(1){height:6px;amaureonixtion-duration:0.8s}.sbar:nth-child(2){height:12px;amaureonixtion-duration:1.1s}.sbar:nth-child(3){height:8px;amaureonixtion-duration:0.9s}.sbar:nth-child(4){height:16px;amaureonixtion-duration:1.3s}.sbar:nth-child(5){height:10px;amaureonixtion-duration:1s}
.gate-hint{margin-top:1.5rem;font-size:0.7rem;color:var(--text-dim);letter-spacing:0.25em;text-transform:uppercase;amaureonixtion:fadePulse 2.5s ease-in-out infinite}
...
.pulse-dot{width:6px;height:6px;border-radius:50%;background:var(--green);box-shadow:0 0 12px var(--green);amaureonixtion:pulseDot 2.2s infinite}
...
.holo-prism{position:relative;width:100%;max-width:380px;transform-style:preserve-3d;amaureonixtion:prismAutoRotate 12s ease-in-out infinite;transition:transform 0.1s}
...
.holo-prism::before{content:'';position:absolute;inset:-20px;background:radial-gradient(circle at 50% 50%,var(--cyan),transparent 70%);opacity:0.2;filter:blur(40px);z-index:-1;amaureonixtion:holoGlow 4s ease-in-out infinite}
...
.marquee-track{display:flex;gap:0.75rem;width:max-content;amaureonixtion:marqueeLeft 35s linear infinite;touch-action:pan-y}
.marquee-wrapper:nth-child(2) .marquee-track{amaureonixtion:marqueeRight 40s linear infinite}
.marquee-wrapper:hover .marquee-track{amaureonixtion-play-state:paused}
...
.pair-steps::before{content:'';position:absolute;top:28px;left:15%;right:15%;height:1px;background:linear-gradient(90deg,transparent,var(--cyan),var(--green),transparent);opacity:0.3;z-index:0;amaureonixtion:linePulse 3s ease-in-out infinite}
...
.step-holo::before{content:'';position:absolute;inset:-1.5px;border-radius:calc(var(--radius) + 1.5px);background:linear-gradient(45deg,var(--cyan),var(--green),var(--fox),var(--blue),var(--cyan));background-size:300% 300%;amaureonixtion:holoBorder 3s linear infinite;z-index:-1}
...
.p-step-num::after{content:'';position:absolute;inset:-4px;border-radius:50%;border:1px solid var(--border-bright);amaureonixtion:ringPulse 2s infinite}
...
.pair-card::before{content:'';position:absolute;top:0;left:0;right:0;height:3px;background:linear-gradient(90deg,var(--cyan),var(--green),var(--fox),var(--blue));background-size:300% 100%;amaureonixtion:gradientMove 5s ease infinite}
...
.result-box{max-width:520px;margin:0 auto;border-radius:var(--radius);padding:1.5rem;background:rgba(0,0,0,.3);border:1px solid var(--border);display:none;text-align:center;amaureonixtion:fadeUp 0.5s var(--ease-out-expo);backdrop-filter:blur(10px);position:relative;z-index:3}
...
.term-cursor{display:inline-block;width:8px;height:16px;background:var(--cyan);vertical-align:middle;margin-left:4px;amaureonixtion:cursorBlink 1s step-end infinite;box-shadow:0 0 10px var(--cyan)}
...
.chat-toggle-btn{
  ...
  amaureonixtion:floatLogo 6s ease-in-out infinite;
}
...
.chat-toggle-btn:hover::before{opacity:0.4;amaureonixtion:ringPulse 2s infinite}
...
.chat-panel{
  ...
  overflow:hidden;amaureonixtion:panelIn 0.5s var(--ease-out-expo);backdrop-filter:blur(40px);
...
.chat-bubble{max-width:88%;padding:0.875rem 1.125rem;border-radius:14px;font-size:0.88rem;line-height:1.6;word-break:break-word;amaureonixtion:msgIn 0.4s var(--ease-out-expo);position:relative}
...
.modal-overlay{position:fixed;inset:0;background:rgba(0,0,0,0.65);backdrop-filter:blur(12px);z-index:10004;display:none;align-items:center;justify-content:center;padding:1rem;amaureonixtion:fadeUp 0.3s ease}
.cyber-modal{background:var(--panel-solid);border:1px solid var(--border-bright);border-radius:1.5rem;padding:2rem;max-width:440px;width:100%;position:relative;box-shadow:0 30px 90px rgba(0,0,0,0.7);amaureonixtion:fadeUp 0.4s var(--ease-out-expo)}
...
const gateCanvas=$('#gateCanvas');const gCtx=gateCanvas?gateCanvas.getContext('2d'):null;let gateNodes=[];let gateAnimId;function resizeGateCanvas(){if(!gateCanvas)return;gateCanvas.width=window.innerWidth;gateCanvas.height=window.innerHeight;}window.addEventListener('resize',resizeGateCanvas);resizeGateCanvas();const nodeCount=isTouchDevice?30:60;for(let i=0;i<nodeCount;i++){gateNodes.push({x:Math.random()*window.innerWidth,y:Math.random()*window.innerHeight,vx:(Math.random()-0.5)*0.3,vy:(Math.random()-0.5)*0.3,size:Math.random()*1.5+0.5});}function drawGateNodes(){if(!gCtx||document.hidden){gateAnimId=requestAmaureonixtionFrame(drawGateNodes);return;}gCtx.clearRect(0,0,gateCanvas.width,gateCanvas.height);gateNodes.forEach((n,i)=>{n.x+=n.vx;n.y+=n.vy;if(n.x<0)n.x=gateCanvas.width;if(n.x>gateCanvas.width)n.x=0;if(n.y<0)n.y=gateCanvas.height;if(n.y>gateCanvas.height)n.y=0;gCtx.beginPath();gCtx.arc(n.x,n.y,n.size,0,Math.PI*2);gCtx.fillStyle='rgba(0,240,255,'+(n.size/3)+')';gCtx.fill();for(let j=i+1;j<gateNodes.length;j++){const n2=gateNodes[j],dx=n.x-n2.x,dy=n.y-n2.y,d=Math.sqrt(dx*dx+dy*dy);if(d<120){gCtx.beginPath();gCtx.moveTo(n.x,n.y);gCtx.lineTo(n2.x,n2.y);gCtx.strokeStyle='rgba(0,240,255,'+(0.08*(1-d/120))+')';gCtx.lineWidth=0.4;gCtx.stroke();}}});gateAnimId=requestAmaureonixtionFrame(drawGateNodes);}if(!prefersReducedMotion)drawGateNodes();
const gateContent=$('#gateContent');if(gateContent&&!isTouchDevice){let tiltRaf;gateContent.addEventListener('mousemove',(e)=>{cancelAmaureonixtionFrame(tiltRaf);tiltRaf=requestAmaureonixtionFrame(()=>{const rect=gateContent.getBoundingClientRect();const x=(e.clientX-rect.left)/rect.width-0.5;const y=(e.clientY-rect.top)/rect.height-0.5;gateContent.style.transform='scale(1.03) translateZ(20px) perspective(1000px) rotateY('+(x*10)+'deg) rotateX('+(-y*10)+'deg)';});});gateContent.addEventListener('mouseleave',()=>{cancelAmaureonixtionFrame(tiltRaf);gateContent.style.transform='';});}
...
function enterSystem(){const btn=$('#audioToggle');if(!musicStarted){musicStarted=true;initMusic();if(btn){btn.textContent='🔊';btn.classList.remove('muted');btn.setAttribute('aria-pressed','true');}}const gate=$('#gate');const flash=$('#flash');const app=$('#app');const infOverlay=$('#infinityOverlay');infOverlay.classList.add('show');requestAmaureonixtionFrame(()=>infOverlay.classList.add('infinity-amaureonixte'));setTimeout(()=>{infOverlay.style.opacity='0';infOverlay.style.transition='opacity 0.6s ease';setTimeout(()=>{infOverlay.classList.remove('show','infinity-amaureonixte');infOverlay.style.opacity='';infOverlay.style.transition='';gate.classList.add('opening');flash.classList.add('active');$$('.scan-bar').forEach((bar,i)=>{bar.style.amaureonixtionDuration='0.6s';bar.style.amaureonixtionDelay=(i*0.12)+'s';});setTimeout(()=>{gate.style.opacity='0';gate.style.visibility='hidden';gate.setAttribute('aria-hidden','true');app.style.display='block';app.style.visibility='visible';requestAmaureonixtionFrame(()=>app.classList.add('visible'));setTimeout(()=>{$$('.scan-bar').forEach(bar=>{bar.style.amaureonixtionDuration='';bar.style.amaureonixtionDelay='';});flash.classList.remove('active');startTypewriter();amaureonixteCounters();},900);},500);},600);},2400);}
...
let spotRaf;document.addEventListener('mousemove',(e)=>{if(isTouchDevice)return;cancelAmaureonixtionFrame(spotRaf);spotRaf=requestAmaureonixtionFrame(()=>{document.documentElement.style.setProperty('--mx',e.clientX+'px');document.documentElement.style.setProperty('--my',e.clientY+'px');});},{passive:true});
const holoPrism=$('#holoPrism');if(holoPrism&&!isTouchDevice){let prismRaf;holoPrism.addEventListener('mousemove',(e)=>{cancelAmaureonixtionFrame(prismRaf);prismRaf=requestAmaureonixtionFrame(()=>{const rect=holoPrism.getBoundingClientRect();const x=(e.clientX-rect.left)/rect.width-0.5;const y=(e.clientY-rect.top)/rect.height-0.5;holoPrism.style.amaureonixtion='none';holoPrism.style.transform='perspective(1000px) rotateY('+(x*20)+'deg) rotateX('+(-y*20)+'deg)';});});holoPrism.addEventListener('mouseleave',()=>{cancelAmaureonixtionFrame(prismRaf);holoPrism.style.amaureonixtion='';holoPrism.style.transform='';});}
const canvas=$('#particleCanvas');const ctx=canvas?canvas.getContext('2d'):null;let particles=[];let particleAnimId;function resizeCanvas(){if(!canvas)return;const dpr=window.devicePixelRatio||1;canvas.width=window.innerWidth*dpr;canvas.height=window.innerHeight*dpr;canvas.style.width=window.innerWidth+'px';canvas.style.height=window.innerHeight+'px';if(ctx)ctx.scale(dpr,dpr);}window.addEventListener('resize',resizeCanvas);resizeCanvas();const particleCount=isTouchDevice?40:90;for(let i=0;i<particleCount;i++){particles.push({x:Math.random()*window.innerWidth,y:Math.random()*window.innerHeight,vx:(Math.random()-0.5)*0.2,vy:(Math.random()-0.5)*0.2,size:Math.random()*2+0.5,alpha:Math.random()*0.35+0.1});}function drawParticles(){if(!ctx||document.hidden){particleAnimId=requestAmaureonixtionFrame(drawParticles);return;}const w=window.innerWidth,h=window.innerHeight;ctx.clearRect(0,0,w,h);particles.forEach((p,i)=>{p.x+=p.vx;p.y+=p.vy;if(p.x<0)p.x=w;if(p.x>w)p.x=0;if(p.y<0)p.y=h;if(p.y>h)p.y=0;ctx.beginPath();ctx.arc(p.x,p.y,p.size,0,Math.PI*2);ctx.fillStyle='rgba(0, 240, 255, '+p.alpha+')';ctx.fill();for(let j=i+1;j<particles.length;j++){const p2=particles[j],dx=p.x-p2.x,dy=p.y-p2.y,dist=Math.sqrt(dx*dx+dy*dy);if(dist<140){ctx.beginPath();ctx.moveTo(p.x,p.y);ctx.lineTo(p2.x,p2.y);ctx.strokeStyle='rgba(0, 240, 255, '+(0.05*(1-dist/140))+')';ctx.lineWidth=0.5;ctx.stroke();}}});particleAnimId=requestAmaureonixtionFrame(drawParticles);}if(!prefersReducedMotion)drawParticles();
...
async function getPairCode() {
  ...
  btn.disabled = true;
  btn.innerHTML = '<span style="display:inline-block;amaureonixtion:spin 1s linear infinite">⟳</span> Processing...';
...
function amaureonixteCounters(){$$('[data-target]').forEach(el=>{const target=parseInt(el.dataset.target);if(!target||target===0)return;const duration=2000;const start=performance.now();function update(now){const elapsed=now-start;const progress=Math.min(elapsed/duration,1);const eased=1-Math.pow(1-progress,3);el.textContent=Math.floor(eased*target)+(target>=100?'+':'');if(progress<1)requestAmaureonixtionFrame(update);}requestAmaureonixtionFrame(update);});}
...
document.addEventListener('visibilitychange',()=>{if(document.hidden){if(gateAnimId)cancelAmaureonixtionFrame(gateAnimId);if(particleAnimId)cancelAmaureonixtionFrame(particleAnimId);}else{if(!prefersReducedMotion){if(gateCanvas)drawGateNodes();if(canvas)drawParticles();}}});

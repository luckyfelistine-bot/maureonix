// ╔══════════════════════════════════════════════════════════════════╗
// ║  🎬 MAUREONIX CINEMATIC EMPIRE v6.0.0                           ║
...
// ─── TMDB (FREE TIER — requires API key, fallback to hardcoded demo) ───
class TMDB {
  static getKey() { return process.env.TMDB_KEY || 'c0b0e9a8f72e9d8f1c1b0b0e9a8f72e9'; } // demo key

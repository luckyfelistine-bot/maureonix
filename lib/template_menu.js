...
async function setTemplateMenu(maureonix, type, m, prefix, setv, db, options = {}) {
    const _dayMap = {
...
> *Maureonix* [BOT] | CREATED BY INFINITE VYBEFLIX`;
    ...
    const menuButtons = [
        ...
        { name: 'quick_reply', buttonParamsJson: JSON.stringify({ display_text: '4️⃣ 🔍 SEARCH', id: `${prefix}searchmenu` }) },
        ...
        { name: 'quick_reply', buttonParamsJson: JSON.stringify({ display_text: '8️⃣ 💰 ECONOMY', id: `${prefix}economymenu` }) },
        { name: 'quick_reply', buttonParamsJson: JSON.stringify({ display_text: '9️⃣ 📅 DAILY', id: `${prefix}dailymenu` }) },
        { name: 'quick_reply', buttonParamsJson: JSON.stringify({ display_text: '🔟 💪 HEALTH', id: `${prefix}healthmenu` }) },
        { name: 'quick_reply', buttonParamsJson: JSON.stringify({ display_text: '1️⃣1️⃣ 📊 FINANCE', id: `${prefix}financemenu` }) },
        { name: 'quick_reply', buttonParamsJson: JSON.stringify({ display_text: '1️⃣2️⃣ 📱 SOCIAL', id: `${prefix}socialmenu` }) },
        { name: 'quick_reply', buttonParamsJson: JSON.stringify({ display_text: '1️⃣3️⃣ 💻 DEV', id: `${prefix}devmenu` }) },
        { name: 'quick_reply', buttonParamsJson: JSON.stringify({ display_text: '1️⃣4️⃣ ✈️ TRAVEL', id: `${prefix}travelmenu` }) },
        { name: 'quick_reply', buttonParamsJson: JSON.stringify({ display_text: '1️⃣5️⃣ 🍔 FOOD', id: `${prefix}foodmenu` }) },
    ...
    await maureonix.sendListMsg(m.chat, {
        text: menuText,
        footer: `© Maureonix`,
        mentions: [m.sender],
        buttons: menuButtons

...
// VERSION: 6.1.2 — CRISIS + ENHANCED AI + IDENTITY FIX + RESPONSE SANITIZER
...
// Forbidden patterns to strip from AI responses
const FORBIDDEN_RESPONSE_PATTERNS = [
  ...
  /I,\s*Aevibron/gi,
  /Aevibron\s+here/gi,
  /I\s+am\s+Aevibron/gi,
  /As\s+Aevibron/gi,
  /\n?\s*\*?Aevibron\*?\s*\n?/gi,
  /\n?\s*Aevibron\s+Labs?\s*$/gim,
  /\n?\s*Created\s+by\s+Aevibron\s*$/gim,
  /\n?\s*Developed\s+by\s+Aevibron\s*$/gim,
  /\n?\s*Powered\s+by\s+Aevibron\s*$/gim,
  /\n?\s*—\s*Aevibron\s*$/gim,
  /\n?\s*Best,\s*Aevibron\s*$/gim,
  /\n?\s*Regards,\s*Aevibron\s*$/gim,
  /\n?\s*Sincerely,\s*Aevibron\s*$/gim,
  /\n?\s*Cheers,\s*Aevibron\s*$/gim,
  /\n?\s*Yours,\s*Aevibron\s*$/gim,
  /\n?\s*Love,\s*Aevibron\s*$/gim,
  /\n?\s*Take\s+care,\s*Aevibron\s*$/gim,
  /\n?\s*Stay\s+safe,\s*Aevibron\s*$/gim,
  /\n?\s*Warmly,\s*Aevibron\s*$/gim,
  /\n?\s*With\s+love,\s*Aevibron\s*$/gim,
  /\n?\s*Your\s+friend,\s*Aevibron\s*$/gim,
  /\n?\s*Your\s+AI,\s*Aevibron\s*$/gim,
  /\n?\s*Your\s+assistant,\s*Aevibron\s*$/gim,
];
...
class AevibronAI {
  ...
  buildSystemPrompt(basePrompt = null, context = 'normal') {
  ...
  /**
   * Sanitize AI response — strip forbidden identity references
   */
  ...
  async enhancedAI(prompt, userId, modelPref = 'deepseek', customSystem = null) {
    ...
    const systemContent = customSystem || this.buildSystemPrompt(null, 'private');
    const messages = [{ role: 'system', content: systemContent }];
    if (userId) {
      const memory = this.getMemory(userId);
      for (const mem of memory.slice(-10)) {

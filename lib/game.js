...
// ── Existing games (unchanged logic, improved messages) ───────────────────────
...
module.exports = {
    // RAWG / new games
    gameList, topGames, searchGame, randomGame, gamesByGenre,
    // Classic games
    gameSlot, gameCasinoSolo, gameSamgongSolo, gameMerampok, gameBegal,
    mathQuiz, mathAnswer, blackjack, blackjackAction,
    // Economy
    daily, buy, transfer, setLimit, addLimit, setMoney, addMoney,
    // State maps (for nima.js to access)
    mathQuizSessions, blackjackSessions,
};

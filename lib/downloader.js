...
// ─── WRAPPER FUNCTIONS FOR ALL COMMANDS ─────────────────────────
...
async function tiktokDownload(url) { return universalDownload(url, { audio: false }); }
async function igDownload(url)     { return universalDownload(url, { audio: false }); }
async function fbDownload(url)     { return universalDownload(url, { audio: false }); }
async function twitterDownload(url) { return universalDownload(url, { audio: false }); }
async function pinterestDownload(url) { return universalDownload(url, { audio: false }); }
async function redditDownload(url) { return universalDownload(url, { audio: false }); }
async function soundcloudDownload(url) { return universalDownload(url, { audio: true }); }
async function threadsDownload(url) { return universalDownload(url, { audio: false }); }
async function capcutDownload(url) { return universalDownload(url, { audio: false }); }
async function likeeDownload(url)  { return universalDownload(url, { audio: false }); }
async function snapchatDownload(url) { return universalDownload(url, { audio: false }); }
async function vimeoDownload(url)  { return universalDownload(url, { audio: false }); }
async function dailymotionDownload(url) { return universalDownload(url, { audio: false }); }
async function mediafireDownload(url) { return universalDownload(url, { audio: false }); }
async function gdriveDownload(url) { return universalDownload(url, { audio: false }); }
// spotifyDownload and apkDownload are already defined above
...
module.exports = {
    ...
    detectPlatform,
    PLATFORM_MAP,
    // Wrappers for command compatibility
    ytMp3,
    ytMp4,
    tiktokDownload,
    igDownload,

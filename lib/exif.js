...
async function writeExif(media, data) {
    ...
    if (data) {
        ...
        const { 
            wra = data.pack_id ? data.pack_id : global.author ? global.author : '🦊 MAUREONIX', 
            wrb = data.packname ? data.packname : global.packname ? global.packname : '🦊 MAUREONIX', 
            wrc = data.author ? data.author : global.author ? global.author : 'Infinite Vybeflix', 

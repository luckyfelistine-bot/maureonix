...
const { iGame, similarity } = require('./function');   // similarity is in lib/function.js
const almost = 0.66;                                   // the same threshold used in nima_core

/**
 * @param {object} nimesha – Baileys socket
 ...
 */
async function handleGameMessage(nimesha, m, ctx) {
    ...
    // 8. SNAKE LADDER
    if (await snakeLadderResponse(nimesha, m, db)) return true;
